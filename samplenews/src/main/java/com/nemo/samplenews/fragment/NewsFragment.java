...
import com.nemo.samplenews.http.GetNewsForId;
import com.nemo.samplenews.view.CommonAdapter;
import com.nemo.samplenews.view.ViewHolder;
import com.nemo.samplenews.view.XListView;
...
public class NewsFragment extends Fragment implements XListView.IXListViewListener {
    ...
    private void initListView() {
        ...
        new GetNewsForId(handler, channelId).start();
    }
    ...
    public void onLoadMore() {
        ...
        new GetNewsForId(handler, channelId,page).start();
    }
