 ...
 */
public class OrgSettingMemberView extends AppCompatActivity implements XListView.IXListViewListener,IUserView{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.org_setting_member_main);
    ...
    private void initData() {
        topBar = (TopBar) findViewById(R.id.topBarOrSettingMember);
    ...
    private void initView() {
        ...
        xListView = (XListView) findViewById(R.id.org_setting_member_list);
        xListView.setPullLoadEnable(true);
        mAdapter = new CommonAdapter<UserBean>(OrgSettingMemberView.this, items,
            ...
            public void convert(final ViewHolder holder, UserBean t) {
                ...
                if(t.getImg().getUrl()!=null) {
                    String url = t.getImg().getUrl();
                    Picasso.with(OrgSettingMemberView.this).load(url).into((CircleImageView) holder.getView(R.id.org_setting_member_image));
                }
            }
        };
        ...
        xListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
              Intent intent = new Intent(getApplicationContext(),MemberView.class);
                String username = items.get(i-1).getUsername();
