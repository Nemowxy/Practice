package com.xy.lifemanage.view.widget;
...
public class AlertDialog {
	...
	public AlertDialog setPositiveButtonForText(String text,
										 final OnAlertListener listener) {
		showPosBtn = true;
		if ("".equals(text)) {
			btn_pos.setText("确定");
		} else {
		...
		btn_pos.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				listener.onClick(txt_edit.getText().toString(),v);
				dialog.dismiss();
			}
		});
		return this;
	...
	public interface OnAlertListener{
		void onClick(String str,View v);
	}
